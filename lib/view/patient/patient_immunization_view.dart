...
class PatientImmunizationView extends StatelessWidget {
  PatientImmunizationView({super.key});
          ...
          ElevatedButton(
            onPressed: () async {
              if (titleController.text.isNotEmpty &&
                ...
                ImmunizationModel newImmunization = ImmunizationModel(
                ...
                await _healthRecordVM.addImmunization(newImmunization);
                Get.back();
              }
            },
            child: Text("Add"),
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return _healthRecordVM.immunizations.isEmpty
            ? Center(child: Text("No Immunizations Found"))
            : ListView.separated(
